...
class SharedUser(BaseModel):
    ...
    twitter_username: typing.Optional[typing.Optional[str]] = Field(None, alias='twitter_username')

    github_username: typing.Optional[typing.Optional[str]] = Field(None, alias='github_username')
