...
from dev_python_sdk.pydantic.articles_create_new_article_response_tags import ArticlesCreateNewArticleResponseTags
from dev_python_sdk.pydantic.articles_create_new_article_response_user import ArticlesCreateNewArticleResponseUser

class ArticlesCreateNewArticleResponse(BaseModel):
    tags: typing.Optional[ArticlesCreateNewArticleResponseTags] = Field(None, alias='tags')
    ...
    collection_id: typing.Optional[typing.Union[int, float]] = Field(None, alias='collection_id')
    ...
    edited_at: typing.Optional[typing.Optional[str]] = Field(None, alias='edited_at')
    ...
    user: typing.Optional[ArticlesCreateNewArticleResponseUser] = Field(None, alias='user')
    class Config:
