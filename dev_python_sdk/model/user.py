...
class User(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["summary", "type_of", "id", "username", "name", "twitter_username", "github_username", "website_url", "location", "joined_at", "profile_image", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["summary", "type_of", "id", "username", "name", "twitter_username", "github_username", "website_url", "location", "joined_at", "profile_image", ], str]):
