...
class Segment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type_of", "user_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type_of", "user_count", ], str]):
