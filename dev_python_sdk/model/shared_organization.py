...
class SharedOrganization(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "username", "slug", "profile_image", "profile_image_90", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "username", "slug", "profile_image", "profile_image_90", ], str]):
