...
class SharedUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "username", "twitter_username", "github_username", "website_url", "profile_image", "profile_image_90", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "username", "twitter_username", "github_username", "website_url", "profile_image", "profile_image_90", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        twitter_username: typing.Union[MetaOapg.properties.twitter_username, None, str, schemas.Unset] = schemas.unset,
        github_username: typing.Union[MetaOapg.properties.github_username, None, str, schemas.Unset] = schemas.unset,
