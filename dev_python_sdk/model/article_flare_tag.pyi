...
class ArticleFlareTag(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "bg_color_hex", "text_color_hex", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "bg_color_hex", "text_color_hex", ], str]):
